...
| [UI system standard](./maintainers/ui-system.md)      | Theme adapter, primitives, layout contracts, test matrix, and debt ratchet      |
| [Code review standard](./maintainers/code-review.md)  | Review process: budget, passes, severity, zone checklists, solo-maintainer mode |
